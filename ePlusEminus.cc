...
int const NumberOfThread = 15;
int cBeamEnergy = 91.2;
 
void *handle(void *ptr)
{
	int ith = (long)ptr;
	TFile *output = new TFile(Form("TauProd_Asymmetrical_TypeI_5e5_t%d.root",ith),"recreate");
	...
	pythia.readString("Beams:eA = 0.75*cBeamEnergy");
	pythia.readString("Beams:eB = 0.25*cBeamEnergy");
